                ...
                <div class="page-inner">
                    ...
                    <header class="page-title-bar">
                        ...
                        <div class="d-md-flex align-items-md-start">
                            <h1 class="page-title mr-sm-auto"> Occasions </h1><!-- .btn-toolbar -->
                            <div class="btn-toolbar">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{route('admin.occasion.create')}}" class="dropdown-item">Add
                                            Occasion</a>
                                    </div>
                                </div>
                            </div><!-- /.btn-toolbar -->
                        ...
                        <div class="card card-fluid">
                            ...
                            <div class="card-header">
                                ...
                                <ul class="nav nav-tabs card-header-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active show" href="{{route('admin.occasion.index')}}">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#" class="tile tile-img mr-1">
                                                        <img class="img-fluid" src="{{$occasion->icon()}}"
                                                             alt="Card image cap"></a>
                                                    <a href="#">{{$occasion->name}}</a>
                                                </td>
                                                <td class="align-middle">
                                                    <span
                                                            class="badge {{$occasion->updated_at->diffInMinutes() < 60 ? "badge-warning" : "badge-info" }}">
                                                    {{$occasion->updated_at->diffForHumans()}}
                                                    </span>

                                                </td>
                                                <td class="align-middle text-right">
                                                    <div style="display: inline-block;">
                                                        <a href="{{route('admin.occasion.edit',$occasion)}}"
                                                    ...
                                                    <div style="display: inline-block;">
                                                        <form method="POST"
                                                              action="{{route('admin.occasion.destroy',$occasion)}}">
                                                            @csrf
                                                            @method('delete')
