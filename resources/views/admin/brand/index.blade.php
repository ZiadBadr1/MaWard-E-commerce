                ...
                <div class="page-inner">
                    ...
                    <header class="page-title-bar">
                        ...
                        <div class="d-md-flex align-items-md-start">
                            <h1 class="page-title mr-sm-auto"> Brands </h1><!-- .btn-toolbar -->
                            <div class="btn-toolbar">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{route('admin.brand.create')}}" class="dropdown-item">Add
                                            Brand</a>
                                    </div>
                                </div>
                            </div><!-- /.btn-toolbar -->
                        ...
                        <div class="card card-fluid">
                            ...
                            <div class="card-header">
                                ...
                                <ul class="nav nav-tabs card-header-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active show" href="{{route('admin.brand.index')}}">
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="#" class="tile tile-img mr-1">
                                                        <img class="img-fluid" src="{{$brand->icon()}}"
                                                             alt="Card image cap"></a>
                                                    <a href="#">{{$brand->name}}</a>
                                                </td>
                                                <td class="align-middle">
                                                    <span
                                                            class="badge {{$brand->updated_at->diffInMinutes() < 60 ? "badge-warning" : "badge-info" }}">
