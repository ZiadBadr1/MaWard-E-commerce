                ...
                <div class="page-inner">
                    ...
                    <header class="page-title-bar">
                        ...
                        <div class="d-md-flex align-items-md-start">
                            <h1 class="page-title mr-sm-auto"> Sliders </h1><!-- .btn-toolbar -->
                            <div class="btn-toolbar">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{route('admin.slider.create')}}" class="dropdown-item">Add slider</a>
                                    </div>
                                </div>
                            </div><!-- /.btn-toolbar -->
                        ...
                        <div class="card card-fluid">
                            ...
                            <div class="card-header">
                                ...
                                <ul class="nav nav-tabs card-header-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active show" href="{{route('admin.slider.index')}}">
                                        ...
                                        @foreach($sliders as $slider)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <span
                                                            class="badge {{$slider->updated_at->diffInMinutes() < 60 ? "badge-warning" : "badge-info" }}">
