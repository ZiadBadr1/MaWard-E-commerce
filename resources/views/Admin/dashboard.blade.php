                        ...
                        <div class="col-12 col-lg-6 col-xl-4">
                            ...
                            <div class="card card-fluid">
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="card-footer-item">
                                        <i class="fa fa-fw fa-circle text-purple"></i> 75% <div class="text-muted small"> Open Ticket </div>
                                    </div>
                                    <div class="card-footer-item">
                                        <i class="fa fa-fw fa-circle text-teal"></i> 60% <div class="text-muted small"> Solved Ticket </div>
                                    </div>
                                </div><!-- /.card-footer -->
                            </div><!-- /.card -->
                        </div><!-- /grid column -->
